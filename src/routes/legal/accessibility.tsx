  ...
  return (
    <LegalPage kicker="// Legal" title="Accessibility Statement" updated="May 2026">
      ...
      <Section title="Need help?">
        <p>If you have trouble using any part of this website, please call us at (614) 683-5763 or email <a href="mailto:access@chimcrew.com" className="text-primary">access@chimcrew.com</a> and a real person on our crew will help you book service over the phone.</p>
      </Section>
