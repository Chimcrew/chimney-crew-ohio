  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-primary/[0.04] to-background">
      ...
      <div className="relative z-20 mx-auto max-w-7xl px-4 pb-12 pt-8 sm:px-6 sm:pb-10 sm:pt-8 md:pb-14 lg:px-8 lg:pt-12">
        ...
        <h1 className="mt-8 max-w-4xl font-sans !text-[26px] font-bold !leading-[1.10] tracking-[-1px] text-foreground sm:!text-[30px] md:!text-[36px] mb-2">
          The Chimney Experts You've Trusted for Over 18 Years In Columbus, Cincinnati, Dayton
        </h1>

        <p className="mt-5 font-sans text-[20px] font-bold leading-snug text-foreground sm:text-[26px] md:text-[30px]">
        ...
        <div className="mt-8 flex flex-col items-start gap-4 sm:flex-row sm:flex-wrap sm:gap-3">
          <a
            href="#hero-lead-form"
            data-cta
        ...
        <a
          href="tel:6146835763"
          className="mt-5 inline-flex w-fit items-center gap-1.5 rounded-full bg-[#E63A1F] px-3 py-1.5 font-mono text-[11px] font-bold uppercase tracking-wider text-white shadow-sm transition hover:brightness-110"
        >
