        ...
        <div className="relative mx-auto grid max-w-[96rem] grid-cols-[auto_1fr_auto] items-center gap-2 px-3 py-2 sm:px-5 md:py-3 xl:px-8">
          ...
          <div className="hidden shrink-0 items-center justify-end gap-2 lg:flex">
            ...
            <button
              type="button"
              onClick={() => openScheduleDialog()}
              className="group relative inline-flex h-10 items-center gap-2 overflow-hidden whitespace-nowrap rounded-full bg-[oklch(0.78_0.19_92)] px-5 font-display text-[11px] font-black uppercase tracking-[0.1em] text-header-ink shadow-[0_4px_16px_oklch(0.78_0.19_92/0.3)] transition hover:bg-[oklch(0.85_0.18_92)]"
            >
          ...
          <div className="relative z-40 ml-auto flex shrink-0 items-center gap-2 lg:hidden">
            <a
              href="tel:6146835763"
              aria-label="Call (614) 683-5763"
              className="grid h-10 w-10 place-items-center rounded-full border border-[oklch(0_0_0/0.14)] bg-background/80 text-header-ink shadow-sm transition hover:bg-[oklch(0.88_0.19_92/0.28)]"
            >
            ...
            {/* Mobile toggle */}
            <button
              className="grid h-10 w-10 place-items-center rounded-full border border-[oklch(0_0_0/0.14)] bg-background/80 text-header-ink shadow-sm"
