      ...
      >
        <div className="relative mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-1.5 md:px-8 md:py-3">
          ...
          <div className="hidden items-center gap-2 md:flex">
            <a
              href="tel:6146835763"
              className="inline-flex items-center gap-3 whitespace-nowrap border border-[oklch(0.18_0.02_250/0.1)] bg-[oklch(0.18_0.02_250/0.03)] px-7 py-4 font-sans text-[16px] font-bold tracking-normal text-foreground/80 transition hover:border-[oklch(0.78_0.19_92/0.5)] hover:text-[oklch(0.65_0.18_92)]"
            >
              <Phone className="h-6 w-6 shrink-0" /> (614) 683-5763
            </a>
            <button
              type="button"
              onClick={() => openScheduleDialog()}
        ...
        <div ref={mobileMenuRef} className="absolute left-0 right-0 top-full z-[60] max-h-[calc(100dvh-4rem)] overflow-y-auto overscroll-contain border-b border-border/40 bg-background shadow-[0_20px_40px_oklch(0.18_0.02_250/0.12)] text-foreground md:hidden">
          <div className="mx-auto max-w-7xl px-4 pt-6 pb-8">
            ...
            <div className="mt-4 grid grid-cols-2 gap-2">
              <a
                href="tel:6146835763"
                className="flex items-center justify-center gap-2 border border-[oklch(0.18_0.02_250/0.1)] bg-[oklch(0.18_0.02_250/0.03)] px-3 py-5 font-sans text-[16px] font-bold tracking-normal text-foreground/80"
              >
