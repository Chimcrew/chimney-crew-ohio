    ...
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 border-t border-flame/30 bg-primary/95 backdrop-blur-xl shadow-[0_-8px_30px_oklch(0_0_0/0.4)] md:hidden">
        <div className="grid grid-cols-2 gap-2 p-2 pb-[max(0.5rem,env(safe-area-inset-bottom))]">
          <a
            href="tel:6146835763"
            className="inline-flex items-center justify-center gap-1.5 rounded-xl border-2 border-white/20 bg-white/5 px-3 py-3 font-display text-[12px] font-extrabold uppercase tracking-wider text-primary-foreground transition active:scale-95"
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 rounded-xl bg-flame px-3 py-3 font-display text-[12px] font-extrabold uppercase tracking-wider text-primary shadow-[0_6px_18px_oklch(0.78_0.19_92/0.45)] transition active:scale-95"
