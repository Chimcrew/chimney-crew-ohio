  ...
  return (
    ...
    >
        ...
        <div className="relative">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-[oklch(0.12_0.01_250)] shadow-[0_30px_80px_oklch(0_0_0/0.55)]">
            ...
            <div className="relative aspect-[5/4] overflow-hidden">
              <img
                src={droneImg}
                alt="Aerial drone inspecting a residential brick chimney in Ohio at golden hour"
                className="h-full w-full object-cover drone-float"
                loading="lazy"
                decoding="async"
                width={1024}
                height={1024}
              ...
              <div className="pointer-events-none absolute inset-0">
                <div className="absolute left-1/2 top-1/2 h-32 w-32 -translate-x-1/2 -translate-y-1/2 rounded-md border border-flame/70 shadow-[0_0_24px_oklch(0.78_0.19_92/0.45)]" />
                <div className="absolute left-1/2 top-1/2 h-px w-32 -translate-x-1/2 -translate-y-1/2 bg-flame/70" />
                <div className="absolute left-1/2 top-1/2 h-32 w-px -translate-x-1/2 -translate-y-1/2 bg-flame/70" />
              </div>
              {/* Corner brackets */}
      ...
      <style>{`
        ...
        .drone-float { animation: drone-float 6s ease-in-out infinite; }
      `}</style>
    </section>
  );
}
