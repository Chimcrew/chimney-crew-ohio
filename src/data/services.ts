...
export const SERVICES: ServiceSpec[] = [
  ...
  },
  {
    ...
    warranty: "Written Safety Report",
    title: "Gas Fireplace Inspection",
    shortTitle: "Gas Fireplace Inspection",
    tagline: "CO-safe, leak-checked, and documented — only $49.",
    price: "$49",
    duration: "",
    icon: Search,
    variant: "inspection",
    accent: "sky",
    hero: {
      eyebrow: "NFPA 211 + manufacturer spec",
      headline: "Gas burns clean — until it doesn't.",
      sub: "A full safety inspection of your gas insert, log set, or direct-vent fireplace. Pilot, burner, venting, seals, and CO readings — written report in your inbox same day.",
    },
    bullets: [
      "Gas leak test at every accessible fitting",
      "Carbon monoxide reading at the appliance",
      "Pilot, thermocouple, and burner inspection",
      "Venting, glass, and gasket integrity check",
      "Digital photo report emailed same day",
    ],
    process: [
      { title: "Shutdown", desc: "Gas off, unit allowed to cool, glass front pulled if needed." },
      { title: "Leak check", desc: "Electronic sniffer on every accessible joint and valve." },
      { title: "Combustion test", desc: "Relight, draft test, and CO reading at the front of the unit." },
      { title: "Report", desc: "Photos and findings emailed same day, ranked by urgency." },
    ],
    signs: [
      "It's been over a year since the last inspection",
      "You bought the home recently",
      "Faint gas odor or soot on a gas unit",
      "Pilot won't stay lit or yellow flame",
    ],
    faqs: [
      { q: "Why $49?", a: "It's a flat seasonal price to get more Ohio homeowners on a safe annual cycle. No upsell — if we don't find anything, you get a clean report." },
      { q: "Is this the same as a tune-up?", a: "No. Inspection is documentation and safety only. A full service tune-up (pilot, burner, seals cleaned) is our Gas Fireplace Service at $218." },
      { q: "Do you work on all brands?", a: "Yes — Heat & Glo, Majestic, Lennox, Napoleon, Mendota, Regency, and more." },
    ],
    related: ["gas-fireplace-service", "level-1-inspection", "annual-plan"],
    metaDescription: "Gas fireplace inspection in Ohio — only $49. CO check, leak test, written safety report. Columbus, Cincinnati, Dayton.",
  },
  {
