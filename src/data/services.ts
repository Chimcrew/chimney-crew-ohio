...
export const SERVICES: ServiceSpec[] = [
  {
    ...
    metaDescription: "Professional chimney sweep in Ohio. HEPA-contained creosote removal, $189 flat. Includes photo report. Columbus, Cincinnati, Dayton.",
  },
  {
    ...
    metaDescription: "NFPA Level 1 chimney inspection in Ohio. $129 flat with photo report. Bundle free with a sweep. Columbus, Cincinnati, Dayton.",
  },
  {
  ...
  },
  {
    ...
    metaDescription: "Humane animal removal from chimneys in Ohio. From $349, includes a stainless cap. Same-day service available.",
  },
  {
    slug: "cap-install",
    ...
    metaDescription: "Stainless steel chimney cap installation in Ohio. From $279 with lifetime warranty. Keeps animals, rain, and sparks out.",
  },
  {
    slug: "waterproofing",
    ...
    metaDescription: "Chimney waterproofing in Ohio with ChimneySaver. From $475, 10-year warranty. Stop spalling and freeze-thaw damage.",
  },
  {
  ...
  },
  {
    ...
    metaDescription: "Firebox rebuild and refractory repair in Ohio. From $1,250. Code-compliant firebrick and panels.",
  },
  {
    ...
    metaDescription: "Smoke chamber parging in Ohio. From $675. Refractory parge coat to fix smoke spillage and pass inspection.",
  },
  {
    slug: "damper-repair",
    ...
    metaDescription: "Chimney damper repair and top-sealing damper install in Ohio. From $195. Stop drafts and lower heating bills.",
  },
  {
    ...
    metaDescription: "Gas fireplace service in Ohio. $229 annual tune-up. Pilot, burner, seals, and CO check for vented gas inserts and log sets.",
  },
  {
    ...
    related: ["chimney-sweep", "annual-plan", "level-1-inspection"],
    metaDescription: "Dryer vent cleaning in Ohio. $149 with rotary brushes and HEPA vacuum. Prevent the #1 cause of laundry-room fires.",
  },
  {
    slug: "annual-plan",
    ...
    metaDescription: "Annual chimney service plan in Ohio. $249/yr for sweep, inspection, priority dispatch, and 10% off repairs.",
  },
];
