...
export const SERVICES: ServiceSpec[] = [
  ...
  },
  {
    ...
    hero: {
      ...
      sub: "A Level 2 inspection adds an internal camera scan of the entire flue to everything in a Level 1 — the written documentation lenders and insurers ask for. Required under NFPA 211 after a chimney fire, before a home sale, or any time you change appliances.",
    },
    bullets: [
      "Internal camera scan of the full flue, top to bottom — cracked tiles, gaps and blockages caught on camera",
      "Includes the complete Level 1: firebox, damper, smoke chamber, crown, cap, flashing and masonry",
      "Written PDF documentation accepted by Ohio lenders and insurers",
      "Every finding bundled into one report with our CSIA credentials, emailed to you",
    ],
    process: [
      { title: "Level 1 review", desc: "We inspect every accessible interior and exterior area first — firebox, damper, smoke chamber, crown, cap and flashing." },
      { title: "Camera scan", desc: "A calibrated camera is fed down the entire flue to reach what a visual check can't see." },
      { title: "Defect review", desc: "Cracked or shifted tiles, gaps and blockages are photographed and flagged by severity." },
      { title: "PDF report", desc: "Findings and our CSIA credentials are bundled into one lender-ready PDF and emailed to you." },
    ],
    signs: [
      "You're buying or selling the home and need documentation for closing",
      "There was a chimney fire — even a small one",
      "You're adding or swapping a wood stove, insert, or gas appliance",
      "Your lender or insurer is requesting a written chimney report",
    ],
    faqs: [
      { q: "What's the difference between a Level 1 and a Level 2 inspection?", a: "A Level 1 is a visual check of every accessible part of the chimney. A Level 2 includes everything in a Level 1 and adds an internal camera scan of the entire flue. NFPA 211 requires a Level 2 after a chimney fire, before a home sale, or when you change appliances." },
      { q: "When do I need a Level 2 chimney inspection?", a: "Any time you're buying or selling the home, after a chimney fire (even a small one), or when you add or swap a wood stove, insert, or gas appliance — and whenever a lender or insurer asks for written documentation." },
      { q: "Are your Level 2 inspection reports accepted by lenders?", a: "Yes. Our PDF report includes our CSIA credentials and is accepted by every Ohio lender we've worked with, along with insurers requesting documentation." },
      { q: "How much does a Level 2 chimney inspection cost?", a: "Our Level 2 inspection is $318 and includes the full Level 1 inspection, the internal camera scan, and the written PDF report." },
      { q: "Can you do a same-day Level 2 inspection for a closing?", a: "Often yes — closing dates move fast. Call us at (614) 683-5763 and we'll do our best to squeeze you in." },
    ],
    related: ["level-1-inspection", "liner-install", "crown-tuckpoint"],
    metaDescription: "NFPA 211 Level 2 chimney inspection in Ohio — full flue camera scan plus a lender-accepted PDF report for home sales, post-fire checks and appliance changes. $318.",
    problems: [
      "A home sale or insurance policy that requires documented proof of a sound chimney",
      "A chimney fire that may have cracked flue tiles where you can't see the damage",
      "A new wood stove, insert, or gas appliance that changes what the flue has to handle",
      "Hidden flue defects — cracked tiles, gaps, or blockages — that a visual-only inspection can miss",
    ],
    benefits: [
      "Documentation lenders and insurers accept, with our CSIA credentials on the report",
      "Camera confirmation of what's really happening inside the flue, not just an educated guess",
      "A clear, severity-ranked list of any defects so you can prioritize repairs",
      "Often available same-day when a closing date is tight",
    ],
  },
  {
  ...
  },
  {
    ...
    hero: {
      ...
      sub: "A stainless liner sized to your specific appliance improves draft, contains heat and combustion gases, and protects your home from creosote-fueled fires. We install insulated 316Ti — the industry's best alloy — sealed top and bottom and backed by a transferable lifetime warranty.",
    },
    bullets: [
      "316Ti stainless — the industry's best alloy, built to outlast the chimney",
      "Sized to your specific appliance — wood stove, insert, furnace, or gas log set",
      "Insulated wrap for stronger draft and better efficiency",
      "Sealed at the top and bottom, then smoke- and draft-tested before we leave",
      "Transferable lifetime warranty that carries to the next owner",
    ],
    process: [
      { title: "Sizing", desc: "We measure your appliance and flue, then select the exact liner diameter it needs." },
      { title: "Removal", desc: "Old clay tiles or a damaged liner are pulled out first if they're in the way." },
      { title: "Install", desc: "The insulated 316Ti liner is dropped in from the top and sealed at both the top and bottom." },
      { title: "Verify", desc: "We finish with a smoke test, a draft test, and a final inspection before first use." },
    ],
    signs: [
      "Cracked or shifted clay tiles found during a chimney inspection",
      "A wood stove or insert added to an older masonry fireplace",
      "Smoke spilling back into the room even after a sweep",
      "Your insurer is asking for a UL-listed liner",
      "An oversized flue causing poor draft and fast creosote build-up",
    ],
    faqs: [
      { q: "Why choose a stainless steel liner?", a: "Clay tiles crack under thermal shock; stainless flexes with heat and lasts the life of the home. We install 316Ti — the industry's best alloy — with an insulated wrap." },
      { q: "Will a new liner improve my draft?", a: "Almost always. A properly-sized liner is the single biggest fix for poor draft, and it's often what finally stops smoke from spilling back into the room." },
      { q: "Do I need a liner if I added a wood stove or insert?", a: "Usually yes. An old flue often isn't sized or rated for a newly added wood stove or gas insert. We size a stainless liner to your specific appliance so it drafts correctly and vents safely." },
      { q: "Is your liner UL-listed?", a: "Yes — we install UL-listed 316Ti stainless liners, which is what insurers ask for. Every install is sealed top and bottom and finished with a smoke test, draft test, and final inspection." },
      { q: "How much does a liner installation cost?", a: "Liner installs are custom quoted — the price depends on your flue size, the appliance, and whether old tiles need to be removed. We measure on site and give you the number in writing before any work begins." },
    ],
    related: ["level-2-inspection", "smoke-chamber-parging", "gas-fireplace-service"],
    metaDescription: "316Ti stainless chimney liner installation in Ohio — insulated and sized to your appliance, with a transferable lifetime warranty. Fixes poor draft and smoke spillage.",
    problems: [
      "Cracked clay tiles letting heat and combustion gases reach the surrounding wall cavity",
      "An oversized flue causing poor draft, smoke spillage, and rapid creosote build-up",
      "An old or missing liner that isn't rated for a newly added wood stove or gas insert",
      "Carbon monoxide concerns from a deteriorated, cracked, or unlined flue",
    ],
    benefits: [
      "Stronger draft so your fireplace stops smoking back into the room",
      "Heat and combustion gases contained safely inside the flue — protects the home from chimney fires",
      "Correctly sized for your appliance, whether a wood stove, insert, furnace, or gas log set",
      "A transferable lifetime warranty that carries to the next owner and adds resale value",
    ],
  },
  {
    slug: "animal-removal",
